...
export default function Pricing() {
      ...
      <CTable className="price-table">
        <CTableBody>
          <CTableRow>
            ...
            <CTableHeaderCell>
              <div style={{ borderTopLeftRadius: 10 }}>Transaction Type</div>
            </CTableHeaderCell>
            <CTableHeaderCell colSpan={2} className="double-width">
              <div style={{ borderTopRightRadius: 10 }}>Subscription Type</div>
            </CTableHeaderCell>
          </CTableRow>
          <CTableRow>
            <CTableDataCell>
              <div style={{ borderTopLeftRadius: 10 }} className="row-title">
                Pricing
              </div>
            </CTableDataCell>
            <CTableDataCell>
          ...
          <CTableRow>
            <CTableDataCell>
              <div className="row-title">Transaction Fee</div>
            </CTableDataCell>
            <CTableDataCell>
              <div>
                {" "}
                <span className="label">3.99 % of sale</span>
              </div>
            </CTableDataCell>
            <CTableDataCell>
              <div>
                {" "}
                <span className="label">1.99 %</span>
              </div>
            </CTableDataCell>
            <CTableDataCell>
              <div>
          ...
          <CTableRow>
            <CTableDataCell>
              <div className="row-title">Monthly Hosting Fee</div>
            </CTableDataCell>
            <CTableDataCell>
              <div>
                {" "}
                <span className="label">No Hosting Fee</span>
              </div>
            </CTableDataCell>
            <CTableDataCell>
              <div>
          ...
          <CTableRow>
            <CTableDataCell>
              <div className="row-title">Free Custom Domain</div>
            </CTableDataCell>
            <CTableDataCell>
              <div>
                {" "}
          ...
          <CTableRow>
            <CTableDataCell>
              <div style={{ borderBottomLeftRadius: 10 }}></div>
            </CTableDataCell>
            <CTableDataCell>
              <div className="d-flex justify-content-center">
                <button
                  className="btn btn-primary primary-color button "
          ...
          <div className={`body flex-grow-1 px-3 DefaultMarginBottom whiteBgColor container`}>
            <div className="select-plan-container d-flex flex-column align-items-center">
              ...
              <p className="description">
                Your current Free Plan will be expire soon. You can select a better plan for shop
                experience. You can change your plan at any time.
              </p>
              {renderPriceList()}
              {/* {renderIncludedIn()}
              {renderFaq()}
  ...
  //               Explore our pricing plans below and choose the one that best suits your needs and
  //               budget, so you can start enjoying the benefits of our service.
  //             </div>
  //           </div>

  //           <div className={`body flex-grow-1`}>{renderPricingCardUI()}</div>
  //           <CustomFooter />
  //         </div>
  //       </div>
  //     );
